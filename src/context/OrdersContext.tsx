    ...
    items: [
      {
        ...
        selectedExtras: [{ id: 'cheddar', label: 'Cheddar slice', price: 80, groupId: 'cheese', groupLabel: 'Cheese' }],
      },
    ],
    total: 1148,
    ...
    items: [
      {
        ...
        selectedExtras: [{ id: 'extra-naan', label: 'Extra naan', price: 100, groupId: 'bread', groupLabel: 'Bread' }],
        specialNotes: 'Less oil please',
      },
    ],
    total: 1888,
    status: 'DELIVERED',
